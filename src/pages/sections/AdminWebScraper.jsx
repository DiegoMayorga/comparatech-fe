            ...
            {!webScraperInitiate ? (
                            ...
                            <div className="categories-scraper-container">
                                ...
                                <label>
                                    <input
                                        ...
                                        onChange={(e) => setMercadoLibreComputers(!mercadoLibreComputers)}
                                    />
                                    Computadores
                                </label>
                                <label>
                                    <input
                                        ...
                                        onChange={(e) => setMercadoLibreMonitors(!mercadoLibreMonitors)}
                                    />
                                    Monitores
                                </label>
                                <label>
                                    <input
                                        ...
                                        onChange={(e) => setMercadoLibreTablets(!mercadoLibreTablets)}
                                    />
                                    Tablets
                                </label>
                            </div>
                ...
                <div className="web-scraper-dialog-container">
                    ...
                    <p className="forgot-password-text">
                        ...
                        de la búsqueda de productos en la web.
                    </p>
                </div>
            )
            }
